 ...
 * Transforms directives not supported back to original form as it can break user content
 */
...
export const remarkAdmonitions: Plugin<[], Root> = () => (tree) => {
  visit(tree, (node, index, parent) => {
    ...
    // Do not change prefix to AD, ADM, or similar or adblocks will block content.
    const admonition = h(
      "aside",
